package at.fhhgb.mc.Aufgabe02.List;

import at.fhhgb.mc.Iterable.Iterator;
import at.fhhgb.mc.Observable.*;
 ...
 * containing element.
 * 
 * The list is now an observerd Object which notifies changes to the Observer.
 * 
 * @author Michael Nigl
 * @version 1.3
 * @param <T>
 *            the generic type all nodes in that list are supposed to have for
 *            the Iterator and Observer
 */

public class DoubleLinkedList<T> extends MyObservable<T> implements
		at.fhhgb.mc.Iterable.Iterable<T> {

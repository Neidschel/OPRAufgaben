...
public class BinarySearchTree {
	 ...
	 * @return - true if insertion was successful; false otherwise.
	 */
	private boolean insert(BinaryTreeNode node,int elem) { 
	 ...
	 * @return - true if the value could be found, false otherwise. 
	 */
	private boolean find(BinaryTreeNode node,int key) { 
	 ...
	 * @return - true if the key could be found and was removed, false otherwise.
	 */
	private boolean remove (BinaryTreeNode node,BinaryTreeNode head,int key) { 
	 ...
	 */
	private int toArray (int[] elements,boolean ascending,int offset,BinaryTreeNode node) {

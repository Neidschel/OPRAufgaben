...
public class BinarySearchTreeTest {
	...
	@Test
	public void testFindZeroElements() throws ValueException, NullPointerException{
		BinarySearchTree tree = new BinarySearchTree();
	...
	@Test
	public void testRemoveRootRightOnly() throws ValueException, NullPointerException{
		BinarySearchTree tree = new BinarySearchTree();
		tree.insert(10);
		tree.insert(15);
		tree.insert(18);
	...
	@Test
	public void testRemoveRootLeftOnly() throws ValueException, NullPointerException{
		BinarySearchTree tree = new BinarySearchTree();
		tree.insert(10);
		tree.insert(5);
		tree.insert(3);
	...
	@Test
	public void testRemoveRootOnly() throws ValueException, NullPointerException{
		BinarySearchTree tree = new BinarySearchTree();
		tree.insert(10);
		assertEquals(true,tree.remove(10));
	...
	@Test
	public void testToArrayAscending() throws ValueException, NullPointerException{
		BinarySearchTree tree = new BinarySearchTree();
		tree.insert(10);
		tree.insert(5);
		tree.insert(15);
	...
	@Test
	public void testToArrayDescending() throws ValueException, NullPointerException{
		BinarySearchTree tree = new BinarySearchTree();
		tree.insert(10);
		tree.insert(5);
		tree.insert(15);

 ...
 * 
 */
public class BinarySearchTree<T extends Comparable<Comparable<?>>> {
	 ...
	 * @return - true if insertion was successful; false otherwise.
	 */
	private boolean insert(BinaryTreeNode node, T elem) {
	 ...
	 * @return - true if the value could be found, false otherwise.
	 */
	private boolean find(BinaryTreeNode node, T key) {
	 ...
	 */
	private int toArray(T[] elements, boolean ascending, int offset,
			BinaryTreeNode node) {
	 ...
	 */
	private T max(BinaryTreeNode node) {
	 ...
	 */
	private T min(BinaryTreeNode node) {
